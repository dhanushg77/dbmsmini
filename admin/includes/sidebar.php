<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li><a href="fee.php"><i class="fa fa-money"></i>Fee Status</a></li>
				<li><a href="list-furnitures.php"><i class="fa fa-table"></i>Furnitures</a></li>
				<!-- <li><a href="add-furnitures.php"><i class="fa fa-table"></i>add Furnitures</a></li> -->
